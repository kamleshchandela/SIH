...
[Quickstart](#-quickstart--installation) • [System Architecture](#-system-architecture) • [Frontend-Backend Bridge](#-frontend--backend-connection-zero-configuration) • [Workflow](#-end-to-end-enforcement-workflow) • [UI Gallery](#-visual-interface-gallery) • [Statutory Artifacts](#-statutory-outputs-csv--pdf-generation) • [Documentation](#-documentation-index)
